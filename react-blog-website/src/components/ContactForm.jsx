...
const ContactForm = () => {;
    ...
    const [showModal, setShowModal] = useState(false); // pop up modal
  ...
  return (
    <div>
        ...
        {/* Pop up modal after email sent */}
        {showModal && (
            <EmailSuccessModal
            message="Message sent"
            duration={4000} // Set the duration in milliseconds (e.g., 3000 = 3 seconds)
            onClose={closeModal}
            />
        )}
    </div>
